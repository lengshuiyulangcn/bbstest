# RailsAdmin config file. Generated on December 13, 2013 00:20
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Bbstest', 'Admin']
  ...
  # config.excluded_models = ['Comment', 'Passage', 'User', 'Userinfo']

  # Include specific models (exclude the others):
  # config.included_models = ['Comment', 'Passage', 'User', 'Userinfo']
...
config.authorize_with do
  ...
  #     configure :passage, :belongs_to_association 
  ...
  #     configure :passage_id, :integer         # Hidden 
  ...
  #     configure :userinfo, :has_one_association 
  #     configure :comments, :has_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your userinfo.rb model definition
